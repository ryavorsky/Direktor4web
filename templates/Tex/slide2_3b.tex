%=====================================================
\begin{frame}{2.3.2. Частотность работы команд}
...
\begin{column}{0.6\textwidth} \begin{tabular}{l} 
 Достаточно часто   \\ 
(``Несколько раз в неделю'' или ``Раз в неделю'')  ---   \valBCByesNum\ (\valBCByesNP\%) \\ [0.3cm]
 Достаточно редко  \\ 
 (``Раз в месяц'' или ``Еще реже'') ---  \valBCBnoNum\ (\valBCBnoNP\%) \\ 
\end{tabular}
\end{column}
\end{columns}
\bigskip
