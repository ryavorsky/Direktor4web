%=====================================================
\begin{frame}{5.3. Данные по вопросам, включенным в блок ``Удовлетворенность работой'' }
...
\includegraphics[width=1.5cm, height=1.5cm]{pie54a.png}
\end{minipage}
\\[0.5cm]
...
\begin{minipage}{1.55cm}
\includegraphics[width=1.5cm, height=1.5cm]{pie54b.png}
\end{minipage}
\end{tabular}
